define([
  ...
  'text!../../Templates/GenericSearch/GenericSearchResults.html',
  'Views/Home/AlertView'

], function ($, _, dust, Backbone, searchResultsItemDetailsView, genericSearchResultsTemplate, alertView) {
    var genericSearchResultsView = Backbone.View.extend({
        el: '#fileContainer',
        SearchData: {},
        initialize: function () {
        },
        events: {
            'click .downdrags': 'searchitemDetails',
        ...
        render: function (res) {
            var self = this;
            var dust_tag = genericSearchResultsTemplate;
            var fileData = {};
        ...
        sortBy: function (e) {
            e.preventDefault();
            var self = this;
            var searchIndex = parseInt(e.target.selectedIndex);
            if (searchIndex == 1) {
                self.sortByNameAsc();
            }
                ...
                self.sortByRankAsc(null);
            }
            else if (searchIndex == 4) {
                self.sortByDownloadAsc(null);
            }           
        ...
        sortByNameAsc: function () {
            ...
            this.SearchData.SearchResult.sort(function (objA, objB) {
                var x = objA.Title.toLowerCase();
                var y = objB.Title.toLowerCase();
        ...
        sortByDate: function () {
            ...
            this.SearchData.SearchResult.sort(function (a, b) {
                var c = new Date(a.CreateDate);
                var d = new Date(b.CreateDate);
                return d - c;
            });
            this.render(this.SearchData);
        }
    ...
    return new genericSearchResultsView;
});